...
pub mod read_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/shelter.ReadService/GetAnimal" => {
                    ...
                    struct GetAnimalSvc<T: ReadService>(pub Arc<T>);
                    impl<
                        T: ReadService,
                    > tonic::server::UnaryService<super::AnimalRequest>
                    for GetAnimalSvc<T> {
                        type Response = super::AnimalResponse;
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ReadService>::get_animal(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "shelter.ReadService";
